...
urlpatterns = [
    ...
    path("Sity/new/", views.Sity_new, name="Sity_new"),
    path("Sity/<int:kp>/edit/", views.Sity_edit, name="Sity_edit"),
    path("Sity/<int:kp>/delete/", views.Sity_delete, name="Sity_delete"),
